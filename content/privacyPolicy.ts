/**
 * Polityka prywatności – treść 1:1 z dokumentu,
 * przepisana do czystego tekstu (bez znaczników HTML).
 */

export const POLITYKA_PRYWATNOSCI = `POLITYKA PRYWATNOŚCI
STRONY INTERNETOWEJ
(HTTPS://WWW.CIENDUCHAGOR.PL)

I/ Dla Właściciela niniejszej strony internetowej, ochrona danych osobowych Użytkowników jest sprawą najwyższej wagi. Dokłada on ogrom starań, aby Użytkownicy czuli się bezpiecznie, powierzając swoje dane osobowe w trakcie korzystania ze strony internetowej.

II/ Przetwarzane są dane osobowe Użytkowników tylko w zakresie niezbędnym do zapewnienia funkcjonalnej strony internetowej i usług. Dane osobowe Użytkowników są przetwarzane wyłącznie za ich zgodą. Wyjątkiem są przypadki, w których nie można uzyskać uprzedniej zgody z przyczyn faktycznych i w których przetwarzanie danych jest dozwolone przez prawo.

III/ Użytkownik to osoba fizyczna, osoba prawna albo jednostka organizacyjna, nieposiadająca osobowości prawnej, której ustawa przyznaje zdolność prawną, korzystająca z usług elektronicznych, dostępnych w ramach strony internetowej.

IV/ Niniejsza polityka prywatności wyjaśnia zasady i zakres przetwarzania danych osobowych Użytkownika, przysługujące mu prawa, jak też obowiązki administratora tych danych, a także informuje o używaniu plików cookies.

V/ Administrator stosuje najnowocześniejsze środki techniczne i rozwiązania organizacyjne, zapewniające wysoki poziom ochrony przetwarzanych danych osobowych oraz zabezpieczenia przed dostępem osób nieupoważnionych.

I. ADMINISTRATOR DANYCH OSOBOWYCH

Administratorem danych osobowych jest Pan Hubert Litwinionek, zamieszkały przy: Szybowcowa 22, 70-843 Szczecin (zwany dalej: „Właściciel").

II. CEL PRZETWARZANIA DANYCH OSOBOWYCH

1. Administrator przetwarza dane osobowe Użytkownika w celu:

W celu kontaktu z klientem i potwierdzeniem rezerwacji.

2. Powyższe oznacza, że przetwarzane dane osobowe Użytkownika są potrzebne w szczególności do:
...
e) Przyjmowanie i obsługa rezerwacji
...
a) rodzaju i wersji używanej przeglądarki;
b) systemu operacyjnego Użytkownika;
c) dostawcy usług internetowych Użytkownika;
d) adresu IP Użytkownika;
e) daty i godziny wejścia przez Użytkownika na stronę internetową;
f) stron internetowych, z których system Użytkownika wchodzi na stronę internetową: HTTPS://WWW.CIENDUCHAGOR.PL;
...
4. Administrator przetwarza również opcjonalne dane, podawane przez Użytkownika:
- data urodzenia;
...
WMF-Uniq,
Ewentualne cookies podmiotów trzecich np. Google maps, booking.
