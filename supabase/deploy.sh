...
echo ""
echo "  2. Set iCal feed URL in Booking.com + Airbnb (import / sync calendar):"
echo "     Direct: https://YOUR_PROJECT_REF.supabase.co/functions/v1/ical-feed"
echo "     Or (Vercel): set ICAL_FEED_URL in Vercel env, then use https://your-domain/calendar.ics"
echo "     In Supabase Table Editor > settings: paste Airbnb export URL into airbnb_ical_url"
echo ""
